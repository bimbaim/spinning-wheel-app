...
export const DEMO_PARTICIPANTS = [
  ...
  { id: '7', name: 'James Garcia', chances: 1, drawn: false, createdAt: new Date().toISOString() },
  { id: '8', name: 'Linda Rodriguez', chances: 2, drawn: false, createdAt: new Date().toISOString() },
  { id: '9', name: 'Robert Lee', chances: 3, drawn: false, createdAt: new Date().toISOString() },
  { id: '10', name: 'Maria Perez', chances: 1, drawn: false, createdAt: new Date().toISOString() },
  { id: '11', name: 'William Miller', chances: 2, drawn: false, createdAt: new Date().toISOString() },
  { id: '12', name: 'Elizabeth Taylor', chances: 3, drawn: false, createdAt: new Date().toISOString() },
  { id: '13', name: 'Richard Scott', chances: 1, drawn: false, createdAt: new Date().toISOString() },
  { id: '14', name: 'Jennifer White', chances: 2, drawn: false, createdAt: new Date().toISOString() },
  { id: '15', name: 'Thomas Hall', chances: 3, drawn: false, createdAt: new Date().toISOString() },
  { id: '16', name: 'Patricia Clark', chances: 1, drawn: false, createdAt: new Date().toISOString() },
  { id: '17', name: 'Charles Lewis', chances: 2, drawn: false, createdAt: new Date().toISOString() },
  { id: '18', name: 'Susan Baker', chances: 3, drawn: false, createdAt: new Date().toISOString() },
  { id: '19', name: 'Joseph Allen', chances: 1, drawn: false, createdAt: new Date().toISOString() },
  { id: '20', name: 'Nancy King', chances: 2, drawn: false, createdAt: new Date().toISOString() },
  { id: '21', name: 'Daniel Wright', chances: 3, drawn: false, createdAt: new Date().toISOString() },
  { id: '22', name: 'Karen Green', chances: 1, drawn: false, createdAt: new Date().toISOString() },
  { id: '23', name: 'Paul Hill', chances: 2, drawn: false, createdAt: new Date().toISOString() },
  { id: '24', name: 'Betty Adams', chances: 3, drawn: false, createdAt: new Date().toISOString() },
  { id: '25', name: 'Mark Campbell', chances: 1, drawn: false, createdAt: new Date().toISOString() },
];
