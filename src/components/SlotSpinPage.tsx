...
export function SlotSpinPage({ isDemoMode, onBack, accessToken }: SlotSpinPageProps) {
  ...
  return new Promise<{ participant: Participant; prize: Prize } | null>((resolve) => {
    ...
    // ⏱ Add delay per roulette stop
    const stopDelay = index * 200; // 0ms for first, 400ms second, etc.
  ...
  return (
    ...
    rounded-2xl shadow-2xl                  {/* Bigger shadow and rounder corners */}
